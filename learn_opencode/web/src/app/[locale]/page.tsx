...
function LayerSection({ layer, locale }: { layer: typeof LAYERS[number]; locale: string }) {
  const colorMap: Record<string, string> = {
    tools: "border-blue-500/30 bg-blue-500/[0.04]",
    planning: "border-emerald-500/30 bg-emerald-500/[0.04]",
    extensibility: "border-purple-500/30 bg-purple-500/[0.04]",
    concurrency: "border-amber-500/30 bg-amber-500/[0.04]",
    platform: "border-red-500/30 bg-red-500/[0.04]",
  };
